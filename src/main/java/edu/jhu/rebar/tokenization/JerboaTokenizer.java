...
public class JerboaTokenizer {
	...
	// Constants
	//======================================================================
	private static final String JERBOA_STAGE_NAME = 
		"jerboa_tokens";
	private static final String JERBOA_TOOL_NAME = 
		"edu.jhu.jerboa.processing.TwitterTokenizer";
	private static final String JERBOA_STAGE_DESCRIPTION = 
		"A tokenization for each sentence, containing tokens and tags "+
	...
	public JerboaTokenizer() throws RebarException {
		this.jerboaMetadata = Concrete.AnnotationMetadata.newBuilder()
			.setTool(JERBOA_TOOL_NAME)
	...
	/** Use the Jerboa tokenizer to tokenize all communications in
	 * the specified corpus. */
	public void tokenizeAllCommunications(Corpus.Reader reader, Corpus.Writer writer)
	...
	/** Run the Jerboa tokenzier on every sentence in the given
	 * communication, and add the resulting tokenizations.  This
	 * modifies the communication, but does not save it; use a
	 * CorpusWriter to save it (or call tokenizeAllCommunications).
	 */
	...
	/** Run the Jerboa tokenizer on the given text string, and return
	 * a Rebar Tokenization containing Jerboa's results.  The returned
	 * Tokenization will have kind=TOKEN_LIST.  In addition to the
	 * tokens, the returned tokenization will also include a
	 * corse-grained tagging generated by the Jerboa tagger.
	 *
	...
	public static void main(String[] args) throws RebarException, IOException {
		// Parse arguments.
		if (args.length < 2) {
			System.err.println("Usage: JerboaTokenizer <corpusname> "+
							   "<dst_stage_version> [<src_stage>...]");
			System.exit(-1);
		}
	...
	public static void tokenize(String corpusName, String dstStageVersion,
								List<String> srcStages) 
		throws RebarException, IOException 
	{
		...
		Stage outputStage = corpus.makeStage(JERBOA_STAGE_NAME, dstStageVersion, 
											 dependencies, JERBOA_STAGE_DESCRIPTION,
											 true);
