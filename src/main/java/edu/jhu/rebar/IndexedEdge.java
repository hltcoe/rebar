...
public class IndexedEdge extends IndexedProto<Concrete.Edge> {
	...
	public IndexedEdge(Concrete.Edge edge, ProtoIndex index, Concrete.DirectedEdgeId.Direction direction)
	...
	/** Return a reversed view of this edge (where src and dst are
	 * swapped).  I.e., if this IndexedEdge's direction is V1_TO_V2,
	 * then return a new IndexedEdge for the same edge but with
	 * direction V2_TO_V1; and vice versa. */
	public IndexedEdge reversed() throws RebarException {
		Concrete.DirectedEdgeId.Direction revDir = 
			(direction==Concrete.DirectedEdgeId.Direction.V1_TO_V2?
	...
	public IndexedEdge(Concrete.Edge edge, ProtoIndex index, 
					   StageOwnership stageOwnership, 
					   Graph.Reader graphReader)
		throws RebarException
	{
		super(edge, index);
	...
	public Concrete.DirectedEdgeId getDirectedEdgeId() {
		return Concrete.DirectedEdgeId.newBuilder()
			.setSrc(getSrcUuid()).setDst(getDstUuid()).build();
	}

	public Concrete.EdgeId getEdgeId() {
		return Concrete.EdgeId.newBuilder()
			.setV1(getV1()).setV2(getV2()).build();
	}
	...
	public void addUndirectedAttribute(FieldDescriptor field, Object value, Concrete.AttributeMetadata metadata) throws RebarException {
		addField(getUndirectedAttributes(), field, 
				 AttribUtil.buildAttribute(field, value, metadata));
	}

	public void addUndirectedAttribute(FieldDescriptor field, Object value, String toolName) throws RebarException {
		addField(getUndirectedAttributes(), field, 
				 AttribUtil.buildAttribute(field, value, toolName));
	}
	...
	public void addForwardAttribute(FieldDescriptor field, Object value, Concrete.AttributeMetadata metadata) throws RebarException {
		addField(getForwardAttributes(), field, 
				 AttribUtil.buildAttribute(field, value, metadata));
	}
	...
	public void addBackwardAttribute(FieldDescriptor field, Object value, Concrete.AttributeMetadata metadata) throws RebarException {
		addField(getBackwardAttributes(), field, 
				 AttribUtil.buildAttribute(field, value, metadata));
	}
	...
	public void addDirectedAttribute(Concrete.UUID src, FieldDescriptor field, Concrete.UUID dst, Object value, Concrete.AttributeMetadata metadata) throws RebarException {
		addField(getDirectedAttributes(src,dst), field,
				 AttribUtil.buildAttribute(field, value, metadata));
	}

	public void addDirectedAttribute(Concrete.UUID src, FieldDescriptor field, Concrete.UUID dst, Object value, String toolName) throws RebarException {
		addField(getDirectedAttributes(src,dst), field,
				 AttribUtil.buildAttribute(field, value, toolName));
	}

	public void addDirectedAttribute(Concrete.UUID src, FieldDescriptor field, Concrete.UUID dst, Object value, String toolName, float confidence) throws RebarException {
		addField(getDirectedAttributes(src,dst), field,
				 AttribUtil.buildAttribute(field, value, toolName, confidence));
	}

	public void addDirectedAttribute(IndexedVertex src, FieldDescriptor field, IndexedVertex dst, Object value, Concrete.AttributeMetadata metadata) throws RebarException {
		addField(getDirectedAttributes(src.getUuid(),dst.getUuid()), field,
				 AttribUtil.buildAttribute(field, value, metadata));
	}

	public void addDirectedAttribute(IndexedVertex src, FieldDescriptor field, IndexedVertex dst, Object value, String toolName) throws RebarException {
		addField(getDirectedAttributes(src.getUuid(),dst.getUuid()), field,
				 AttribUtil.buildAttribute(field, value, toolName));
	}

	public void addDirectedAttribute(IndexedVertex src, FieldDescriptor field, IndexedVertex dst, Object value, String toolName, float confidence) throws RebarException {
		addField(getDirectedAttributes(src.getUuid(),dst.getUuid()), field,
				 AttribUtil.buildAttribute(field, value, toolName, confidence));
	}
	...
	public Concrete.UUID getSrcUuid() {
		return ((direction==Concrete.DirectedEdgeId.Direction.V1_TO_V2) ? 
				getProto().getEdgeId().getV1() : 
				getProto().getEdgeId().getV2());
	}
	...
	/** Return the DirectedAttributes that go from this edge's
	 * source vertex to its destination vertex. */
	public Concrete.DirectedAttributes getForwardAttributes() {
		return ((direction==Concrete.DirectedEdgeId.Direction.V1_TO_V2) ? 
				getProto().getV1ToV2() : getProto().getV2ToV1());
	}

	/** Return the DirectedAttributes that go from this edge's
	 * destination vertex to its source vertex. */
	public Concrete.DirectedAttributes getBackwardAttributes() {
		return ((direction==Concrete.DirectedEdgeId.Direction.V1_TO_V2) ? 
				getProto().getV2ToV1() : getProto().getV1ToV2());
	}

	/** Return this edge's directed attributes going in the specified
	 * direction.  "src" and "dst" must be the vertices of this edge. */
	public Concrete.DirectedAttributes getDirectedAttributes(Concrete.UUID src, Concrete.UUID dst) 
		throws RebarException
	{
	...
	/** Return this edge's directed attributes going in the specified
	 * direction.  "src" and "dst" must be the vertices of this edge. */
	public Concrete.DirectedAttributes getDirectedAttributes(IndexedVertex src, IndexedVertex dst) 
		throws RebarException
	{
	...
	/** Return this edge's directed attributes going in the specified
	 * direction.  "src" and "dst" must be the vertices of this edge. */
	public Concrete.DirectedAttributes getDirectedAttributes(Concrete.Vertex src, Concrete.Vertex dst) 
		throws RebarException
	{
		return getDirectedAttributes(src.getUuid(), dst.getUuid());
	}
	...
	/** Return the numerically lesser UUID of the two vertices
	 * connected by this edge. */
	public Concrete.UUID getV1() {
		return getProto().getEdgeId().getV1();
	}

	/** Return the numerically greater UUID of the two vertices
	 * connected by this edge. */
