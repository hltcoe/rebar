	...
	extends IndexedTokenization
{
	...
	/* package-private */ TokenListIndexedTokenization(Concrete.Tokenization tokenization, ProtoIndex index) 
	...
	public List<TokenSequence> getNBestTokenSequences(int n) throws RebarException {
		...
		if (n>0) result.add(getBestTokenSequence());
		return result;
	}
	...
	public Concrete.Token getNextToken(int tokenId) {
		if (tokenIdToPos==null) buildTokenIdToPos();
