...
abstract public class IndexedTokenization extends IndexedProto<Concrete.Tokenization> {
  ...
  public static IndexedTokenization build(Concrete.UUID uuid, ProtoIndex index) throws RebarException {
  ...
  public static IndexedTokenization build(Concrete.Tokenization tokenization, ProtoIndex index) throws RebarException {
  ...
  protected IndexedTokenization(Concrete.Tokenization tokenization, ProtoIndex index) throws RebarException {
   ...
   * then throw a RebarException. If the tagging does not assign any tag to the given token, then return null.
   */
  ...
  private Map<Integer, String> buildTokenTagIndex(Concrete.TokenTagging tagging) throws RebarException {
