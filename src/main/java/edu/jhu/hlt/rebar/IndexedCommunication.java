...
public class IndexedCommunication extends IndexedProto<Concrete.Communication> {
  ...
  public IndexedCommunication(Concrete.Communication comm, ProtoIndex index, StageOwnership stageOwnership) throws RebarException {
    super(comm, index);
  ...
  /**
   * Return the stage ownership map for this indexed communication. This will be NULL unless you read the communication using
