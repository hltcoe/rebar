...
/**
 * Class used to read in a JSON Tweet record and convert it to a rebar protobuf object (Concrete.TweetInfo). The input JSON record should use the standard
...
public class TweetInfoJsonReader {
  ...
  // (hint: you don't)
  /*
   * @JsonAnySetter public void handleUnknown(String key, Object value){ System.out.println("Unknown value: "+key); }
   */
  // Public interface
