...
/**
 * Class used to read in a JSON Twitter Hashtag record and convert it to a rebar protobuf object (Twitter.TwitterEntities.HashTag). The input JSON record should
