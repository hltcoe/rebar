...
/**
 * Class used to read in a JSON Twitter UserMention record and convert it to a rebar protobuf object (Twitter.TwitterEntities.UserMention). The input JSON
 * record should use the standard twitter API, as defined at:
 * 
