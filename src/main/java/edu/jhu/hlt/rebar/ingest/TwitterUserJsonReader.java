...
class TwitterUserJsonReader {
	...
	@JsonProperty("lang") public void setLang(String lang) { 
		if (lang != null) builder.setLang(lang); }
	...
	@JsonProperty("friends_count") public void setFriendsCount(int friendsCount) { 
		builder.setFriendsCount(friendsCount); }
	@JsonProperty("statuses_count") public void setStatusesCount(int statusesCount) { 
	...
	@JsonProperty("listed_count") public void setListedCount(int listedCount) { 
		builder.setListedCount(listedCount); }
	@JsonProperty("favourites_count") public void setFavouritesCount(int favouritesCount) { 
		builder.setFavouritesCount(favouritesCount); }
	@JsonProperty("followers_count") public void setFollowersCount(int followersCount) { 
	...
	@JsonProperty("time_zone") public void setTimeZone(String timeZone) { 
	...
	@JsonProperty("utc_offset") public void setUtcOffset(int utcOffset) { 
