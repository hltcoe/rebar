...
/**
 * Class used to read in a JSON Twitter Place record and convert it to a rebar protobuf object (Twitter.TwitterPlace). The input JSON record should use the
 ...
 * "protected", // The following are deprecated in the Twitter API "following", "notifications", "id_str", // The following are non-standard additions in the
 * mtire data set "mitre_gender"})
 */
