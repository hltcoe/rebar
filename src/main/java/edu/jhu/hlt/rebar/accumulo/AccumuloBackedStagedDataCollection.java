...
/**
 * Base class for the Accumulo backed Corpus and Graph classes. This class is not indended to be directly instantiated.
 */
public class AccumuloBackedStagedDataCollection implements StagedDataCollection {
  ...
  protected AccumuloBackedStagedDataCollection(String name, boolean create, String tablePrefix, String[] tableSuffixes, String[] protoTableSuffixes,
      byte[] stageCFPrefixes) throws RebarException {
    this.name = name;
