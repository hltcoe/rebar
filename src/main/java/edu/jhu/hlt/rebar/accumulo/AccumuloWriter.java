...
/*package-private*/ class AccumuloWriter {  
	...
	public AccumuloWriter(AccumuloConnector accumuloConnector, String tableName) 
	...
	protected void writeProtoModifications(Stage stage, Text rowId, Map<ProtoIndex.ModificationTarget, byte[]> modifications)
		throws RebarException
	{
	...
	protected void writeProtoModifications(Stage stage, Text rowId, ProtoIndex index) 
		throws RebarException
	{
	...
	protected void write(Text rowId, Text colFamily, Text colQualifier, Value value) 
		throws RebarException
	{
	...
	/** Merge a single field into a message, based on its UUID, field
	 * descriptor, and field value, and return the result.  Raise an
	 * exception if we don't find anywhere to merge it in. 
	 *
	 * This method is actually used by Writers to return the
	 * newly modified value without having to reread it from the table.
	 */
	protected static Message mergeField(Message msg, Concrete.UUID target, 
	...
	private static Message mergeFieldHelper(Message msg, Concrete.UUID target, 
											FieldDescriptor field, Message fieldValue)
		throws RebarException
	{
