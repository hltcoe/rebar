...
import edu.jhu.hlt.rebar.riak.communications.CommunicationIngester;
import edu.jhu.hlt.rebar.riak.communications.CommunicationReader;

/**
 * @author max
 *
 */
public class ITestCommunicationReader {
    
    private static final Logger logger = Logger.getLogger(ITestCommunicationReader.class);
    ...
    /**
     * Test method for {@link edu.jhu.hlt.rebar.riak.communications.CommunicationReader#fetchAllComms(java.lang.String)}.
