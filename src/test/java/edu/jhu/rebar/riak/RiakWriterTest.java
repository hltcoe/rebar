 ...
 *
 */
public class RiakWriterTest {
    private static final Logger logger = Logger.getLogger(RiakWriterTest.class);
    ...
    /**
     * Test method for {@link edu.jhu.rebar.riak.RiakWriter#write(edu.jhu.rebar.riak.RiakCommunication)}.
     * 
