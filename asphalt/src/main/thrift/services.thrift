...
namespace java edu.jhu.hlt.rebar.services
namespace py rebar.services
...
service StageHandler {
  ...
  void createStage(1: stage.Stage stage) throws (1: ex.RebarThriftException exc)
  list<stage.Stage> getStages() throws (1: ex.RebarThriftException exc)
}
