...
//   */
//  @Override
//  public List<Communication> getAnnotatedCommunications(Stage stage) throws AsphaltException, TException {
//    if (!this.ash.stageExists(stage.name))
//      throw new AsphaltException("Stage " + stage.name + " doesn't exist; can't get its documents.");
//
//    try {
