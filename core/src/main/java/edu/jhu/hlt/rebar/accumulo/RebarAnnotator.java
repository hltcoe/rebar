...
//  }
//
//  private AsphaltException generateAnnotationException(StageType type, Exception ex) {
//    return new AsphaltException("There was an error adding an annotation of stage: " + type.toString() + ": " + ex.getMessage());
//  }
//
//  /*
//   * (non-Javadoc)
...
//
//  @Override
//  public void addLanguageId(Communication comm, Stage stage, LanguageIdentification lid) throws TException {
//    if (stage.type != StageType.LANG_ID)
//      throw new AsphaltException("Stage " + stage.name + " is of type " + stage.type.toString() + "; it cannot support a language ID annotation.");
//    try {
...
//   */
//  @Override
//  public void addSectionSegmentation(Communication comm, Stage stage, SectionSegmentation sectionSegmentation) throws AsphaltException, TException {
//    if (!isValidSectionSegmentation(sectionSegmentation))
//      throw new AsphaltException("This is not a valid SectionSegmentation object; it has no sections.");
//
//    if (stage.type != StageType.SECTION)
//      throw new AsphaltException("The type of this stage must be Section, not: " + stage.type.toString());
//
//    try {
//      this.addAnnotation(comm, stage, sectionSegmentation);
//    } catch (MutationsRejectedException | RebarException | IllegalAnnotationException e) {
//      throw new AsphaltException("There was an error during ingest: " + e.getMessage());
//    }
//  }
//
...
//
//  @Override
//  public void addSentenceSegmentations(Communication comm, Stage stage, SentenceSegmentationCollection sentenceSegmentationList) throws AsphaltException,
//      TException {
//    if (stage.type != StageType.SENTENCE)
//      throw new AsphaltException("The type of this stage must be Sentence, not: " + stage.type.toString());
//
//    BooleanToStringTuple t = isValidSentenceSegmentationCollection(comm, sentenceSegmentationList);
//    if (!t.getBoolean())
//      throw new AsphaltException("Your sentence segmentation had an issue: " + t.getMessage());
//
//    try {
...
//
//  @Override
//  public void addTokenizations(Communication comm, Stage stage, TokenizationCollection tokenizations) throws AsphaltException, TException {
//    if (stage.type != StageType.TOKENIZATION)
//      throw new AsphaltException("The type of this stage must be Tokenization, not: " + stage.type.toString());
//
//    try {
...
//
//  @Override
//  public void addEntities(Communication comm, Stage stage, EntitySet es) throws AsphaltException, TException {
//    // TODO Auto-generated method stub
//    if (stage.type != StageType.ENTITIES)
//      throw new AsphaltException("The type of this stage must be " + StageType.ENTITIES.toString() + ", not: " + stage.type.toString());
//
//    try {
...
//
//  @Override
//  public void addEntityMentions(Communication comm, Stage stage, EntityMentionSet ems) throws AsphaltException, TException {
//    // TODO Auto-generated method stub
//    if (stage.type != StageType.ENTITY_MENTIONS)
//      throw new AsphaltException("The type of this stage must be " + StageType.ENTITY_MENTIONS.toString() + ", not: " + stage.type.toString());
//
//    try {
