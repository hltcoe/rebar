...
//
//    List<LanguageIdentification> lidList = new ArrayList<>();
//    for (Communication d : this.docSet) {
//      LanguageIdentification lid = generateLanguageIdentification(d);
//      lidList.add(lid);
...
//    Stage newStage = TestRebarStageHandler.generateTestStage();
//    newStage.type = StageType.TOKENIZATION;
//
//    List<LanguageIdentification> lidList = new ArrayList<>();
//    for (Communication d : this.docSet) {
//      LanguageIdentification lid = generateLanguageIdentification(d);
...
//    List<LanguageIdentification> lidListTwo = new ArrayList<>();
//    for (Communication d : this.docSet) {
//      LanguageIdentification lid = generateLanguageIdentification(d);
//      lidListTwo.add(lid);
...
//      LanguageIdentification lid = lidList.get(i);
//      LanguageIdentification lidTwo = lidListTwo.get(i);
//      String id = d.id;
...
//          LanguageIdentification dser = new LanguageIdentification();
//          this.deserializer.deserialize(dser, e.getValue().get());
